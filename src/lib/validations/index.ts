...
export const discoveryFormSchema = z.object({
  ...
  useCaseDescription: z.string().min(10, "Description must be at least 10 characters"),
  monthlyVolume: z.number().min(1, "Monthly volume must be at least 1"),
  channels: z.array(z.string()).min(1, "At least one channel is required"),
  peakHours: z.string().optional(),
  currentProcess: z.string().min(10, "Current process description must be at least 10 characters"),
...
export type AnalysisCustomizationInput = z.infer<typeof analysisCustomizationSchema>;
